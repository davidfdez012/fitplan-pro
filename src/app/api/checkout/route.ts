...
// 🔔 RECORDATORIO IMPORTANTE PARA ADMIN:
// Debes ir a tu dashboard de Stripe, crear un producto de suscripción por 19€
// y pegar su ID ("price_123...") en la variable de entorno STRIPE_PRICE_ID_PRO
